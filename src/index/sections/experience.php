      ...
      <ul class="timeline">
        ...
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            ...
            <span class="place textbold">Watergenics UG, Berlin, Germany</span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            ...
            <span class="place textbold">Next Big Thing AG, Berlin, Germany</span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            ...
            <span class="place textbold">Senic GmbH, Berlin, Germany</span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            <h3>Co-Founder | Chief Technology Officer</h3>
            <span class="place textbold">Macsxperts, Bangalore, India</span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            ...
            <span class="place textbold">smartB Energy Management GmbH, Berlin, Germany</span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            ...
            <span class="place textbold">The Jodel Venture GmbH, Berlin, Germany</span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            <h3>Embedded Systems Engineer</h3>
            <span class="place textbold">yetu AG, Berlin, Germany</span>
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            <h3>Co-Founder | Chief Technology Officer</h3>
            <span class="place textbold">Academia Grandiosa Medicinae, New Delhi, India</span></span>
          </div>
        </li>
        <li>
          ...
          <div class="timeline-label wow animated fadeIn" data-wow-delay="0.2s">
            <h3>Systems Engineer</h3>
            <span class="place textbold">Tata Consultancy Services, New Delhi, India</span></span>
          </div>
        </li>
      </ul>
    </div>
